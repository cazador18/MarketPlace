...
internal class NewAdsCoordinator: NSObject, AdCoordinator {
    ...
    internal func start() {
        let newAdsPage: NewAdController = .init()
        newAdsPage.viewModel.coordinator = self
        navigationController.pushViewController(newAdsPage, animated: true)
    }
...
extension NewAdsCoordinator: CategorySelectionDelegate {
...
extension NewAdsCoordinator: DealTypeSelectionDelegate {
...
extension NewAdsCoordinator: CurrencyTypeSelectionDelegate {
